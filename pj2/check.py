...
if __name__ == "__main__":
    check(language = "English", gold_path="D:\\Desktop\\english_test.txt", my_path="./English_result1.txt")
    check(language="Chinese", gold_path="D:\\Desktop\\chinese_test.txt", my_path="./Chinese_result1.txt")

    # check(language="English", gold_path="D:\\Desktop\\english_test.txt", my_path="./English_result2.txt")
    # check(language="Chinese", gold_path="Chinese/validation.txt", my_path="./Chinese_result2.txt")
    #
    # check(language="English", gold_path="D:\\Desktop\\english_test.txt", my_path="./English_result3.txt")
    # check(language="Chinese", gold_path="D:\\Desktop\\chinese_test.txt", my_path="./Chinese_result3.txt")